...
export async function GET() {
  ...
  const projects = (data || []).map((row: ProjectRow) => {
    const project = {
      ...
      cardPaddingBottom: row.details?.cardPaddingBottom,
      ...
      linkedPage: row.details?.linkedPage,
      linkedItemId: row.details?.linkedItemId,
...
export async function POST(request: Request) {
  ...
  (newProject as any).details = {
      ...
      cardPaddingBottom: newProject.cardPaddingBottom,
      lockedAspectRatio: newProject.lockedAspectRatio,
      galleryWidthRatio: newProject.galleryWidthRatio,
      ...
      linkedPage: newProject.linkedPage,
      linkedItemId: newProject.linkedItemId,
  ...
  const savedProject = {
    ...
    cardPaddingBottom: data.details?.cardPaddingBottom,
    ...
    linkedPage: data.details?.linkedPage,
    linkedItemId: data.details?.linkedItemId,
...
export async function PUT(request: Request) {
  ...
  const detailsToSave = {
      ...
      cardPaddingBottom: project.cardPaddingBottom,
      lockedAspectRatio: project.lockedAspectRatio,
      galleryWidthRatio: project.galleryWidthRatio,
      type: project.type,
      ...
      linkedPage: project.linkedPage,
      linkedItemId: project.linkedItemId,
